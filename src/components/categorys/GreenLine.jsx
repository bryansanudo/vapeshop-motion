...
import product6 from "@/assets/categorys/greenLine/product6.jpg";
import product7 from "@/assets/categorys/greenLine/product7.jpg";
import product8 from "@/assets/categorys/greenLine/product8.jpg";
  ...
  const portfolios = [
    {
      ...
      src: product1,
      category: "Titulo",
      codeInstagram: "https://www.instagram.com/p/CJqc7kYDkwx/",
    ...
    },
    {
      ...
      src: product2,
      category: "Titulo",
      codeInstagram: "https://www.instagram.com/p/Bs9LdqdngQ7/",
      codeWpp: "https://api.whatsapp.com/send?phone=573043936109",
    },
    {
      id: 3,
      src: product3,
      category: "Titulo",
      codeInstagram: "https://www.instagram.com/p/CF8W5CgsSzT/",
      codeWpp: "https://api.whatsapp.com/send?phone=573043936109",
    },
    {
      id: 4,
      src: product4,
      category: "Titulo",
      codeInstagram: "https://www.instagram.com/p/CHXmwgaj4tf/",
      codeWpp: "https://api.whatsapp.com/send?phone=573043936109",
    },
    {
      id: 5,
      src: product5,
      category: "Titulo",
      codeInstagram: "https://www.instagram.com/p/CTRt2WHL4bR/",
      codeWpp: "https://api.whatsapp.com/send?phone=573043936109",
    },
    {
      id: 6,
      src: product6,
      category: "Titulo",
      codeInstagram: "https://www.instagram.com/p/CQs53qIDFH-/",
      codeWpp: "https://api.whatsapp.com/send?phone=573043936109",
    },
    {
      id: 7,
      src: product7,
      category: "Titulo",
      codeInstagram: "https://www.instagram.com/p/CEJyPxxskzj/",
      codeWpp: "https://api.whatsapp.com/send?phone=573043936109",
    },
    {
      id: 8,
      src: product8,
      category: "Titulo",
      codeInstagram: "https://www.instagram.com/p/BmYHFXFg_sB/",
      codeWpp: "https://api.whatsapp.com/send?phone=573043936109",
    },
  ];
      ...
      <div className="mx-auto flex h-full w-full max-w-screen-lg flex-col justify-center p-4 ">
        ...
        <div className="grid gap-8 md:px-12 grid-cols-1 sm:grid-cols-2  lg:grid-cols-2">
          {portfolios.map(({ id, src, codeInstagram, category, codeWpp }) => (
            <div
              key={id}
              className="rounded-lg shadow-lg shadow-[#ddfd30] group"
            >
